      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Dock Master's Log", role: "Evidence",
            text: "A charter manifest, hastily amended: one passenger added on a southbound flight to the Cape winelands — “the Cape, first light.”",
            dest: true },
        ...
        dest: { clue: "A charter to the Cape winelands — first light at the foot of Table Mountain, where two oceans meet.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Service Elevator", role: "Evidence",
            text: "The only anomaly: the freight lift logged a single unscheduled descent to the loading dock, then a courier crate booked north to the crémant houses of a narrow golden slope famed for Pinot Noir.",
            dest: true },
        ...
        dest: { clue: "A courier crate booked north to the crémant houses of the narrow golden Pinot slope.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Rail Yard Ledger", role: "Evidence",
            text: "A sealed wine-wagon coupled to the overnight express across the Alps to the fog-wreathed Alpine foothills where Nebbiolo ages and Asti sparkles.",
            dest: true },
        ...
        dest: { clue: "An overnight wagon across the Alps to the fog-wreathed Alpine foothills where Nebbiolo ages and Asti sparkles.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Customs Stub", role: "Evidence",
            text: "A discreet export form: one climate-controlled trunk, declared “glassware,” routed to the slate-steep Riesling switchbacks of a steep German river.",
            dest: true },
        ...
        dest: { clue: "A trunk marked “glassware,” bound for the steepest slate slopes in Germany, Riesling country.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Loading Bay", role: "Evidence",
            text: "Tyre tracks and a dropped cargo tag: a river barge chartered down to the terraced river gorges where Port is born.",
            dest: true },
        ...
        dest: { clue: "A barge chartered to the terraced river gorges where Port is born.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Airstrip Log", role: "Evidence",
            text: "A light plane filed a short dawn hop north — to the highest vineyards in the country, the highest Torrontés terraces in the Andean north.",
            dest: true },
        ...
        dest: { clue: "A dawn hop north to the highest white-wine terraces in the land, far up the Andean north.",
      ...
      },
      {
        ...
        leads: [
          { title: "Airfield Marshal", role: "Evidence",
            text: "“Refuelled a light plane at first light — filed across the Pacific for the old-vine Shiraz country of South Australia. You just missed him by an hour.”",
            dest: true },
        ...
        dest: { clue: "A dawn plane across the Pacific to the old-vine Shiraz heartland of South Australia.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Valet Stub", role: "Evidence",
            text: "A torn itinerary under the valet desk: a private jet logged wheels-up for California's cult Cabernet valley before the party had even ended.",
            dest: true },
        ...
        dest: { clue: "A private jet, wheels-up for the cult Cabernet valley of northern California.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Concierge Note", role: "Evidence",
            text: "The hotel concierge — starstruck — booked her next stay himself: a hilltop villa among the cypress-lined Sangiovese hills of central Italy.",
            dest: true },
        ...
        dest: { clue: "A villa in the cypress hills of Sangiovese and Brunello.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Heliport Log", role: "Evidence",
            text: "A helicopter manifest: one passenger, a great deal of luggage, destination the foggy coastal Pinot and Zinfandel country beside California's most famous valley.",
            dest: true },
        ...
        dest: { clue: "A helicopter to the foggy coastal Pinot and Zinfandel country beside California's most famous valley.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Forged Invoice", role: "Evidence",
            text: "The fake paperwork is too good — printed on a press only three houses own. One sits on a steep, Syrah-clad bend of a great southern French river.",
            dest: true },
        ...
        dest: { clue: "A press found in only three houses — one on the steep Syrah terraces of a great French river.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Freight Tag", role: "Evidence",
            text: "A single shipping tag fluttered loose under the press: a crate routed to a fine-wine vault in California's cult Cabernet valley.",
            dest: true },
        ...
        dest: { clue: "A crate routed to a fine-wine vault in California's cult Cabernet valley.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Decoy Ticket", role: "Evidence",
            text: "Left too neatly in the visitor log — a boarding pass to the foggy coastal Pinot country beside the famous valley, seat circled. A taunt. He always leaves one.",
            dest: true },
        ...
        dest: { clue: "A taunting boarding pass to the foggy coastal Pinot country by the bay.",
      ...
      },
      {
        ...
        leads: [
          { title: "Roadhouse Bartender", role: "Evidence",
            text: "“Paid in old francs, tipped me in card tricks. Said he was 'going home to the only honest dirt in America' — the rainy Pinot valley of the Pacific Northwest. Then he was gone.”",
            dest: true },
        ...
        dest: { clue: "'Going home' — the cool, rain-soaked Pinot country of the Pacific Northwest.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Convoy Tracks", role: "Evidence",
            text: "Three black cars, no plates, headed north on the autostrada toward the fog-wreathed Alpine foothills of Nebbiolo and Asti. Witnesses suddenly can't remember a thing.",
            dest: true },
        ...
        dest: { clue: "Three plateless cars, north toward the misty foothills of Nebbiolo and Asti.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Customs Bribe", role: "Evidence",
            text: "A customs officer, suddenly wealthy and very nervous, waved through a sealed truck bound for the steep Syrah terraces above a great southern French river.",
            dest: true },
        ...
        dest: { clue: "A bribed-through truck bound for the steep Syrah terraces of a great French river.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Manifest", role: "Evidence",
            text: "A freight manifest paid in full, in cash: a temperature-controlled lorry crossing the Pyrenees to Spain's storied Tempranillo bodegas on the Ebro.",
            dest: true },
        ...
        dest: { clue: "A cash-paid lorry over the Pyrenees to Spain's oldest Tempranillo country.",
      ...
      },
      {
        ...
        leads: [
          { title: "Stationmaster", role: "Evidence",
            text: "“The convoy came through at dawn and didn't stop. Headed for the one place he's never let us touch — the family estate among the first-growth châteaux where the Gironde meets the sea. He's going home.”",
            dest: true },
        ...
        dest: { clue: "Going home — the family estate among the first-growth châteaux where the Gironde meets the sea.",
    ...
    legs: [
      {
        ...
        leads: [
          ...
          { title: "Tyre Marks", role: "Evidence",
            text: "Deep ruts and a dropped ferry ticket: a freighter booked across the Atlantic for the first-growth château country where the Gironde meets the sea.",
            dest: true },
        ...
        dest: { clue: "A freighter across the Atlantic to the first-growth château country where the Gironde meets the sea.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Customs Slip", role: "Evidence",
            text: "A cargo slip jammed in the gate: one oversized, badly-packed crate manifested to the steep Syrah terraces above a great southern French river.",
            dest: true },
        ...
        dest: { clue: "An oversized crate bound for the steep Syrah terraces above a great southern French river.",
      ...
      },
      {
        ...
        leads: [
          ...
          { title: "Dock Ledger", role: "Evidence",
            text: "A harbourmaster's ledger, ink still wet: a cargo run booked for the old-vine Shiraz heartland of South Australia.",
            dest: true },
        ...
        dest: { clue: "A cargo run booked for the old-vine Shiraz heartland of South Australia.",
      ...
      },
      {
        ...
        leads: [
          { title: "Roadhouse Owner", role: "Evidence",
            text: "“Big fella, ate for three, paid in cash. Said he was 'going somewhere nobody looks' — the cold, wind-scoured bottom of the continent. Then left without paying for the pie.”",
            dest: true },
        ...
        dest: { clue: "'Somewhere nobody looks' — the cold, wind-scoured bottom of the continent.",
